...
void sim_village_main_par(const inncabs::launch l, struct Village *top);
...
void sim_village_par(const inncabs::launch l, struct Village *village)
{
	...
	while(vlist) {
		...
		futures.push_back(inncabs::async(l, sim_village_par, l, vlist));
		vlist = vlist->next;
	}
